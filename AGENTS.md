...
This is a plugin scaffold for the Orchestrator. It provides a baseline Bun/TS project with CI, release tooling, and architectural conventions for the ama-hello-world plugin.
